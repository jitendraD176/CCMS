...
if(isset($_SESSION["id"])) {
	...
	$sql="SELECT * FROM cases WHERE Reporter='$email' ";
        ...
        echo '
			...
			<div style="float: right;">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" readonly class="form-control" id="Head" name="head" value="'.$row["Head"].'">
				  </div>
				  <div class="form-group">
				    <label for="room">Last Date</label>
				    <input type="date" readonly class="form-control" id="room" name="ldate" value="'.$row["LastDate"].'">
				  </div>
				  <div class="form-group">
				    <label for="fee">Next Date</label>
				    <input type="date" readonly class="form-control" id="fee" name="ndate" value="'.$row["NextDate"].'">
				  </div>
